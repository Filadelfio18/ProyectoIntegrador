	...
	<body>
		<div class="contenedor">
			...
			<main class="contenido">
				...
				<article class="articulo">
					<div class="contenedor-texto">
						...
						<p class="extracto">
						<a href="https://www.universoformulas.com/imagenes/fisica/dinamica/ley-hooke-muelle-posicion-equilibrio.jpg"><img src="Imagenhook1.jpg" alt="" style="object-fit: scale-down;" ></a>
						</p>
					</div>
				</article>
				<article class="articulo">
					<div class="contenedor-texto">
						...
						<p class="extracto">
						<a href="https://www.universoformulas.com/imagenes/fisica/dinamica/ley-hooke-muelle-despues-fuerza-externa.jpg"><img src="Imagenhook2.jpg" alt="" style="object-fit: scale-down;" ></a>
						</p>
					</div>
				</article>
				<article class="articulo">
					<div class="contenedor-texto">
						...
						<a class="formulas"><img src="Problema6.jpg" alt="" style="width: 670px; height: 125px; margin-left: 20px;"></a><br><br><br>
			...
			<aside class="sidebar" style="width: 90%; justify-content: right;">
				...
				<a href="https://phet.colorado.edu/sims/html/hookes-law/latest/hookes-law_es.html" target="_blank" style="font-size: 28px;"> >> Da clic para acceder a un simulador << </a><br><br>

				<a href="ejerciciosHooke.php" style="font-size: 28px;"> Ejercicios ! </a>
