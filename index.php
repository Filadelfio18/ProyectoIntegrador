		...
		<div class="contenedor">
				...
				<div class="contenedor-texto">
					...
					<p class="extracto">
						...
						<br>
								...
								<b>-</b><a href="Torricelli.php" style="color: #d0c700 ;">Modelo de Torricelli</a><br>
					</p>
				</div>
				<div class="contenedor-thumbnail">
					<a href="#">
						<img src="logo.png" alt="" style="border-radius: 50%; height: 250px; margin-top: 30px; margin-left: -25px; background-color: #FEFEFE; object-fit:scale-down;" alt="Logo Prgrammed Physics">
					</a>
				</div>
			</article>
			...
			<main class="contenido" id="temas">
				<article class="articulo">
					<div class="contenedor-thumbnail">
						<a href="#"><img src="resorte.jpg" alt="Imegn de un resorte" style="border-radius: 3%;" ></a>
					</div>
					<div class="contenedor-texto">
						<div>
							<h2 class="titulo">
				...
				<article class="articulo">
					<div class="contenedor-thumbnail">
						<a href="#"><img src="prensaHidraulica.jpg" alt="Imagen de una prensa hidraulica" /></a>
					</div>
					<div class="contenedor-texto">
						<div>
							<h2 class="titulo">
								<a>Principio de Pascal</a>
							</h2>
							<p class="fecha">
								<time>1656</time>
							</p>
				...
				<article class="articulo">
					...
					<div class="contenedor-texto">
						...
						<a href="Torricelli.php" class="btn-link">Leer más</a>
					</div>
				</article>
			</main>
