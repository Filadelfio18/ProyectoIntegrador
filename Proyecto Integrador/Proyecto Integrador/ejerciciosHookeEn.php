	        ...
	        <article class="articulo">
	                    <div class="contenedor-texto">
	                        ...
	                        <form action="ejercicios.php" method="POST">
	                          ...
	                          <label for="Primer Ejercicio">A spring elongates 15 cm when a force of 85 Newtons is applied to it. If the spring recovers its original length and then a force of 125 Newtons is applied to it. What is the new elongation of the spring, if the spring does not reach its elastic limit?</label><br><br>
	                        ...
	                        if ($puntos < 6){
                            $mensaje=" You need to study";
                          	}
                          	if ($puntos == 6){
                            	$mensaje =" Approved but you can do better";
                          	}
                          	if ($puntos == 8){
                            	$mensaje =" Approved but you can do better";
                          	}
