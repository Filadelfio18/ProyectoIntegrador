  ...
  <body>
    <div class="contenedor">
      <header class="header" id="header">
        ...
        <a class="botonTraductor"  href="ejerciciosPascalEn.php"> Cambiar a: Inglés </a><br><br>
      ...
      <main class="contenido">
        ...
        <article class="articulo">
                    <div class="contenedor-texto">
                        ...
                        <form action="evaluarPascal.php" method="POST">
                         
                          
                          <label for="Primer Ejercicio">En una prensa el émbolo mayor tiene un diámetro de 45 cm y el émbolo menor de 2.5 cm ¿Qué fuerza se necesita ejercer en el émbolo menor para levantar un bloque de 60000 N?</label><br><br>
                          ...
                          <label for="Primer Ejercicio">Se desea elevar un cuerpo de 1500kg utilizando una elevadora hidráulica de plato grande circular de 90cm de radio y plato pequeño circular de 10cm de radio. Calcula cuánta fuerza hay que hacer en el émbolo pequeño para elevar el cuerpo. </label><br><br>
                          ...
                          <label for="Primer Ejercicio">Sobre el plato menor de una prensa se coloca una masa de 16kg. Calcula qué masa se podría levantar colocada en el plato mayor, cuyo radio es el doble del radio del plato menor.</label><br><br>
                          ...
                          <label for="Primer Ejercicio"> ¿Qué proporción deberían guardar los platos de una prensa hidráulica para que, aplicando 40N de fuerza en el plato menor, podamos levantar un objeto de 80Kg en el plato mayor?</label><br><br>
                          ...
                          <input type="submit" name="Resultado" value="RESULTADOS">
                        </form>
