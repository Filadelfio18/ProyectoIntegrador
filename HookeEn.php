		...
		<div class="contenedor">
			...
			<article class="articulo destacado">
				<div class="contenedor-texto">
					...
					<p class="extracto" style="text-align:justify;">
						Hooke's Law of elasticity, or simply Hooke's Law, is the physical principle around the elastic behavior of solids. It was formulated in 1660 by the British scientist Robert Hooke, a contemporary colleague of the famous Isaac Newton.<br>
						The theoretical precept of this law is that the displacement or deformation suffered by an object subjected to a force will be directly proportional to the deformation force or the load. That is to say, the greater the force, the greater the deformation or displacement, or as Hooke himself formulated it in Latin: <i>Ut tensio sic vis</i> <br>In other words:<br>

						<i><b>" -</b>	The force of any spring is in the same proportion to the tension exerted on it <b>- "</b></i>
						<br>
					</p>
				</div>
				<div class="contenedor-thumbnail">
					<a href="#">
						<img src="RobertHooke.jpg" alt="" style="border-radius: 40%; height: 250px; margin-top: 30px; margin-left: -25px; ; object-fit:scale-down;">
			...
			<main class="contenido">
				<article class="articulo">
					<div class="contenedor-thumbnail">
						<a href="https://www.fisicalab.com/sites/all/files/contenidos/leyesnewton/ley-hook.png"><img src="Leyhook2.jpg" alt="" style="object-fit: scale-down;" ></a>
					</div>
					<div class="contenedor-texto">
						<div>
							<h2 class="titulo">
						...
						<p class="extracto" style="text-align:justify;">
							When you apply a force to a spring, probably this will lengthen. If you double the force, the elongation it will also double.This is what its known as Hooke's Law.<br>
							Hooke's Law states that the lengthening of a spring is directly proportional to the modulus of force applied to it, as long as the said spring is not permanently deformed by the said dock.<br><br>
							<b>F=k⋅(x−x0)</b><br>
							where:<br><br>
				...
				<article class="articulo">
					<div class="contenedor-texto">
						...
						<p class="extracto">
						<a><img src="Imagenhook1En.jpg" alt="" style="object-fit: scale-down;" ></a>
						</p>
					</div>
				</article>
				<article class="articulo">
					<div class="contenedor-texto">
						...
						<p class="extracto">
						<a><img src="Imagenhook2En.jpg" alt="" style="object-fit: scale-down;" ></a>
						</p>
					</div>
				</article>
				<article class="articulo">
					<div class="contenedor-texto">
						<div>
							<h2 class="titulo">
								<a href="#"> Excercise example of Hooke's Law</a>
							</h2>
						</div>
						<p class="extracto">
						...
						<a ><img src="Problema1.jpg" alt="" style="width: 300px; height: 50px; margin-left: 225px;"></a><br>
						<a ><img src="Problema2.jpg" alt="" style="width: 300px; height: 50px; margin-left: 225px;" ></a><br><br>
						...
						<a class="formulas"><img src="Problema4.jpg" alt="" style="width: 500px; height: 50px; margin-left: 150px;"></a><br>
						<p class="extracto">
						...
						<a class="formulas"><img src="Problema6.jpg" alt="" style="width: 300px; height: 100px; margin-left: 200px; object-fit: fill;"></a><br>
					</div>
				</article>
			...
			<aside class="sidebar" style="width: 80%; justify-content: right;">
				...
				<a href="https://phet.colorado.edu/sims/html/hookes-law/latest/hookes-law_es.html" target="_blank" style="font-size: 28px;"> >> Click here to access a simulator << </a><br><br>

				<a href="ejerciciosHookeEn.php" style="font-size: 28px;"> Excercises ! </a>
			</aside>
