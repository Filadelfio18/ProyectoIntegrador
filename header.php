					...
					<ul class="menu">
						...
						<li><a href="index.php #temas">   Temas  </a>
							<ul class="submenu">
								...
								<li><a href="Torricelli.php">Teorema de Torricelli</a></li>
							</ul></li>
						<li><a href="#"> Ejercicios </a>
							<ul class="submenu">
								...
								<li><a href="ejerciciosTorricelli.php">Teorema de Torricelli</a></li>
							</ul></li>
						<li><a href="registrarvista.php">   <?php echo "Usuario: $usuario"; ?> </a></li>
						<li><a href="salir.php">  Cerrar sesión </a></li>
						<?php if ($_SESSION['username']=="maestro"){
							?><li><a href="maestro.php">  Evaluaciones </a></li><?php 
						} ?>
