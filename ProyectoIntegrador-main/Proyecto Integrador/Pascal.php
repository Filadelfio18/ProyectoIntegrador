		...
		<div class="contenedor">
			...
			<main class="contenido">
				...
				<article class="articulo">
					<div class="contenedor-texto">
						...
						<a href="registrarv2.php" class="btn-link">Evaluame</a>
					</div>
				</article>
			...
			<aside class="sidebar" style="width: 80%; justify-content: right;">
				<?php require("sidebar.php"); ?>
					<a href="http://www.objetos.unam.mx/fisica/pascal/index.html" target="_blank" style="font-size: 28px;"> >> Da clic para acceder a un simulador << </a>
