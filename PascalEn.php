		...
		<div class="contenedor">
			...
			<article class="articulo destacado">
				<div class="contenedor-texto">
					...
					<p class="extracto" style="text-align:justify;">
						...
						It is the basis of the operation of hydraulic machines, since a fluid can be used to transmit the change in pressure from one end to the other of a pipe and perform useful mechanical work, such as stopping a car or lifting a large weight by applying less force.<br>
					</p>
				</div>
			...
			<main class="contenido">
				<article class="articulo">
					<div class="contenedor-thumbnail">
						<a><img src="FluidosComprensibles.jpg" alt="" style="object-fit: scale-down;" ></a>
					</div>
					<div class="contenedor-texto">
						<div>
							<h2 class="titulo">
				...
				<article class="articulo">
					<div class="contenedor-texto">
						...
						<p class="extracto">
						<a><img src="ElevadorH.png" alt="" style="object-fit: scale-down;" >Fluid</a>
						</p>
					</div>
				</article>
				<article class="articulo">
				...
				<article class="articulo">
					<div class="contenedor-texto">
						<div>
							<h2 class="titulo">
								<a href="#">Excercise Example of Pascal's Principle:</a>
							</h2>
						</div>
						<p class="extracto" style="text-align: justify;">
						...
						<a ><img src="pimg1En.jpg" alt="" style="width: 700px; height: 440px; margin-left: 20px;"></a><br>
			...
			<aside class="sidebar" style="width: 80%; justify-content: right;">
				<?php require("sidebarEn.php"); ?>
					<a href="http://www.objetos.unam.mx/fisica/pascal/index.html" target="_blank" style="font-size: 28px;"> >>Click here to access a simulator << </a><br><br>
				<a href="ejerciciosPascalEn.php" style="font-size: 28px;"> Excercises ! </a>
			</aside>
