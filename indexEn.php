		...
		<div class="contenedor">
			...
			<article class="articulo destacado">
				...
				<div class="contenedor-thumbnail">
					<a href="#">
						<img src="logo.png" alt="" style="border-radius: 50%; height: 250px; margin-top: 30px; margin-left: -25px; background-color: #FEFEFE; object-fit:scale-down;">
					</a>
				</div>
			</article>
			...
			<main class="contenido" id="topics">
				<article class="articulo">
					<div class="contenedor-thumbnail">
						<a href="#"><img src="resorte.jpg" alt="" style="border-radius: 3%;" ></a>
					</div>
					<div class="contenedor-texto">
						<div>
							<h2 class="titulo">
				...
				<article class="articulo">
					<div class="contenedor-thumbnail">
						<a href="#"><img src="prensaHidraulica.jpg" alt="" /></a>
					</div>
					<div class="contenedor-texto">
						<div>
							<h2 class="titulo">
				...
				<article class="articulo">
					<div class="contenedor-thumbnail">
						<a href="#"><img src="Rotoplas.jpg" alt="" /></a>
					</div>
					<div class="contenedor-texto">
						<div>
							<h2 class="titulo">
								<a>Torricelli's Theorem</a>
							</h2>
							<p class="fecha">
								<time></time>
							</p>
						...
						<p class="extracto">
							In Torricelli's theorem and in the formula that gives the speed, it assumes that the viscosity losses are negligible, just as in free fall it is assumed that the friction due to the air surrounding the 	falling object is negligible. <br><br>
							The above assumption is reasonable in most cases and also involves the conservation of mechanical energy.
						</p>
						<a href="TorricelliEn.php" class="btn-link">Read More!</a>
					</div>
				</article>
			</main>
